                ...
                <div className="space-y-5">
                  ...
                  <div className="bg-yellow-50 border border-yellow-200 rounded-lg p-4">
                    ...
                    <div className="flex justify-between text-sm text-gray-600 mt-1">
                      ...
                      <span className="text-green-700 font-medium">₹{advancePayment.toFixed(2)}</span>
                    </div>
                    <div className="flex justify-between text-sm text-gray-600">
                      <span>Pay later in cash</span>
                      <span className="text-orange-700 font-medium">₹{(totalPrice - advancePayment).toFixed(2)}</span>
                    </div>
                  </div>
                </div>
              )}
              ...
              {step === 3 && (
                <div className="space-y-5">
                  ...
                  <div className="bg-green-50 border border-green-200 rounded-lg p-4 text-sm text-green-900">
                    <p><strong>Pay Now (30% advance):</strong> ₹{advancePayment.toFixed(2)}</p>
                    <p className="mt-1"><strong>Pay Later in cash:</strong> ₹{(totalPrice - advancePayment).toFixed(2)}</p>
                  </div>
