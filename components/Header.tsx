      ...
      <div className="container mx-auto px-4">
        ...
        {mobileMenuOpen && (
          <nav className="md:hidden py-4 border-t border-gray-700 space-y-2">
            <Link href="/" className="block px-4 py-2 hover:bg-primary-900 rounded">
              Home
            </Link>
            <Link href="/book-taxi" className="block px-4 py-2 hover:bg-primary-900 rounded">
              Book Taxi
            </Link>
            <Link href="/tours" className="block px-4 py-2 hover:bg-primary-900 rounded">
              Tours
            </Link>
            {mounted && user && (
              <Link href="/bookings" className="block px-4 py-2 hover:bg-primary-900 rounded">
                My Bookings
              </Link>
            )}
              ...
              <div className="pt-2">
                {user ? (
                  <div className="space-y-2">
                    <div className="px-4 py-2 bg-primary-900 rounded text-sm break-all">{user.email}</div>
                    <button
                      onClick={handleLogout}
                      className="w-full px-4 py-2 bg-red-600 rounded text-center font-semibold hover:bg-red-700 transition-smooth"
                    >
                      Logout
                    </button>
                  </div>
                  ...
                  <div className="flex gap-2">
                    <Link
                      href="/login"
                      className="flex-1 px-4 py-2 text-center border border-secondary-500 rounded"
                    >
                      Login
                    </Link>
                    <Link
                      href="/signup"
                      className="flex-1 px-4 py-2 bg-secondary-500 text-primary-950 rounded text-center font-semibold"
                    >
                      Sign Up
                    </Link>
                  </div>
